...
public class CredentialsCacheLoadingFunction implements Function<User, String>
{
    ...
    public String apply(User user)
    {
        ...
        catch (Exception ex)
        {
            ...
            //    This also means what we will be able to login with "cassandra:cassandra" combination with the necessity to ever reach LDAP server.
            //
            ...
            //
            // If something from 1) and 2) occurs, we have to go against LDAP
